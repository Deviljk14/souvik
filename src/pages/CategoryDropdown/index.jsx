  ...
  return (
    <>
      <div className="bg-white-A700 flex flex-col font-poppins items-center justify-start mx-auto overflow-auto w-full">
        ...
        <div className="h-[368px] md:h-[408px] max-w-[1170px] mt-10 mx-auto md:px-5 relative w-full">
          <Slider
            autoPlay
            ...
            items={[...Array(5)].map(() => (
              <React.Fragment key={Math.random()}>
                <div className="bg-black-900 flex flex-col items-start justify-end mx-2.5 pt-4 px-4">
                  <div className="flex flex-col items-center justify-start ml-12 md:ml-[0] w-[73%] md:w-full">
                    <div className="flex md:flex-col flex-row gap-[38px] items-start justify-between w-full">
                      <div className="flex md:flex-1 flex-col gap-5 items-start justify-start md:mt-0 mt-[42px] w-[36%] md:w-full">
                      ...
                      <div className="h-[352px] relative w-3/5 md:w-full">
                        <Img
                          className="h-[352px] m-auto object-cover w-full"
                          src="images/img_heroendframe.png"
                          alt="heroendframe"
                        />
                        <div className="absolute bg-red-600 bottom-[11%] h-2.5 left-[1%] rounded-[50%] w-2.5"></div>
                      </div>
                    </div>
                  </div>
                </div>
          ...
          />
          <PagerIndicator
            className="absolute bottom-[10%] flex gap-[11px] h-3.5 inset-x-[0] items-center justify-center mx-auto w-[106px]"
            count={5}
        ...
        <div className="flex flex-col font-poppins items-end mt-[146px] pl-[57px] md:px-5 w-full">
        ...
        <Button
          className="cursor-pointer font-medium min-w-[234px] mt-[29px] text-base text-center"
          shape="round"
          color="red_600"
          size="lg"
          variant="fill"
        ...
        <div className="flex flex-col items-end mt-[61px] px-44 md:px-5 w-full">
          <Button
